...
model.entity_property_specs = {
	...
	'aliases': {
		fill: function (val, entity) {
			entity.aliases = (entity.aliases || []).concat(Array.isArray(val) ? val : [val]);
		}
	},
	'tags': {
		fill: function (val, entity) {
			entity.tags = (entity.tags || []).concat(Array.isArray(val) ? val : [val]);
		}
	}
};
