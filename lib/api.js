...
api.prototype.merge_data = function(a,b){
	...
	a.forEach(function(e){
		hashes.push(crypto.createHash("sha256").update(JSON.stringify([a.key, a.format, a.value])).digest('hex'));
		set.push(e);
	});
	b.forEach(function(e){
		if (hashes.indexOf(crypto.createHash("sha256").update(JSON.stringify([a.key, a.format, a.value])).digest('hex')) < 0) set.push(e);
	});
	return set;
};
