...
Share = (function(_super) {
  ...
  Share.prototype.inject_html = function(instance) {
    return instance.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='entypo-pinterest' data-network='pinterest'></li><li class='entypo-twitter' data-network='twitter'></li><li class='entypo-facebook' data-network='facebook'></li><li class='entypo-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li><li class='entypo-whatsapp' data-network='whatsapp'><a class='whatsapp-link' href='whatsapp://send' data-text='Take a look at this awesome website:' data-href=' class='wa_btn wa_btn_s' style='display:none'></a></li></ul></div>";
  };
